...
class TrainConfig:
    ...
    stage2_ir_gray_ratio: float = 0.2
    ...
    fusion_color_sal_weight: float = 0.5
    fusion_color_bg_weight: float = 0.3
    stage2_ssim_weight: float = 3.0
    saliency_weight: float = 0.08
    saliency_ir_target_ratio: float = 0.7
    stage2_ir_edge_weight: float = 2.0
    stage2_vis_edge_bg_weight: float = 1.5
    stage2_vis_hf_weight: float = 1.0
    stage2_vis_hf_bg_weight: float = 1.5
    stage2_vis_hf_sal_weight: float = 0.35
    stage2_vis_lap_weight: float = 0.6
    stage2_vis_lap_bg_weight: float = 1.0
    stage2_vis_lap_sal_weight: float = 0.15
    stage2_edge_focus_weight: float = 1.2
    stage2_vis_bg_int_weight: float = 1.5
    stage2_salient_color_suppress: float = 0.5
