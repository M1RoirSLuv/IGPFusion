...
def parse_args() -> TrainConfig:
    ...
    p.add_argument("--sd_ckpt_path", type=str, default="./model/v1-5-pruned.safetensors")
    ...
    p.add_argument("--ir_prior_unet_path", type=str, default=None, help="Path to UNet dir of IR-finetuned SD model (e.g. ./generative/unet)")
    p.add_argument("--ir_prior_weight", type=float, default=0.1)
    p.add_argument("--ir_prior_layers", type=str, default="1,2", help="Comma-separated down_block indices to extract features from")
